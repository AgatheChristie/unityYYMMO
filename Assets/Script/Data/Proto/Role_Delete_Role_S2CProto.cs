...
public struct Role_Delete_Role_S2CProto : IProto
{
    public ushort ProtoCode { get { return ProtoCodeDef.Role_Delete_Role_C2S; } }

    public ushort IsSuccess;

    public static Role_Delete_Role_S2CProto GetProto(byte[] buffer)
    {
        Role_Delete_Role_S2CProto proto = new Role_Delete_Role_S2CProto();
